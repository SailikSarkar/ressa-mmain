...
const Register = () => {
  ...
  return (
    <section className="relative py-20 2xl:py-40 bg-gray-100 dark:bg-darkk-800  h-screen overflow-hidden">
      <div className="relative container px-4 mx-auto">
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-wrap items-center -mx-4">
            <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
              <div className="max-w-md">
                <span className="text-xl text-yellow-400 font-extrabold">
                  Register Account
                </span>
                <h2 className="mt-8  mb-12 text-5xl font-extrabold font-heading  dark:text-white">
                  Create an account and start pending down your  <p className="  text-yellow-500"> ideas</p> 
                </h2>
              </div>
            </div>
          ...
          <div className="px-6 lg:px-20 py-12 lg:py-24   dark:bg-darkk-900  bg-gray-200   border-2 border-gray-500 rounded-lg">
                <form onSubmit={formik.handleSubmit}>
                  <h3 className="mb-10 text-2xl dark:text-white text-black font-extrabold font-heading">
                    Register Account
                  ...
                  {/* First name */}
                  <div className="flex items-center pl-6 mb-3 bg-yellow-400 rounded-full">
                  ...
                  {loading ? (
                    ...
                    <button
                      type="submit"
                      className="py-4 w-full bg-yellow-500 hover:bg-yellow-600 text-black font-extrabold rounded-full transition duration-200"
                    >
                      Register
                    </button>
                  )}
