...
const UpdatePassword = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-darkk-500  flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full -mt-36 sm:max-w-md">
        <h2 className="mt-6 text-center text-3xl font-extrabold dark:text-gray-100 text-gray-900">
          ...
          <form className="space-y-6" onSubmit={formik.handleSubmit}>
            ...
            <div>
              ...
              {loading ? (
                ...
                <button
                  type="submit"
                  className="inline-flex bg-indigo-200 justify-center w-full px-4 py-2 border border-gray-300 shadow-sm text-sm font-bold rounded-xl text-indigo-700  hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
                >
