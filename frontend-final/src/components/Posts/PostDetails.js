  ...
  return (
    <>
      {loading ? (
        ...
        <section className="py-20 2xl:py-40 bg-gray-100 dark:bg-darkk-800 overflow-hidden">
          <div className="container px-4 mx-auto">
            {/* Post Image */}
            <img
              className="mb-24 w-full h-96 rounded-xl shadow-2xl object-cover"
              src={postDetails?.image}
              alt=""
            />
            <div className="max-w-2xl mx-auto text-center">
              <h2 className="mt-7 mb-14 text-6xl 2xl:text-7xl text-gray-900 dark:text-white font-serif font-heading">
                {postDetails?.title}
              </h2>
                ...
                <div className="text-left">
                  <Link to={`/profile/${postDetails?.user?._id}`}>
                    <h4 className="mb-1 text-2xl font-bold text-gray-50">
                      ...
                      <span className="text-xl lg:text-2xl font-bold text-indigo-700 ">
              ...
              <div class="max-w-xl mx-auto">
                <p class="mb-6 text-left  text-xl dark:text-gray-500 text-gray-900">
